// Nitro.d.ts - v0.0.3
declare namespace Nitro {
    var DEBUG_MODE: boolean;
    var DIGEST_USING_MICROTASKS: boolean;
    ...
    abstract class Component<I = {}> {
        ...
        private _renderer;
        private _mountedState;
        protected input: I;
        constructor();
        setInput(input: I): void;
        inputChanged(previous: I, current: I): void;
        setDirty(): void;
        isMounted(): boolean;
        mountUnder(parent: HTMLElement): void;
        unmount(): void;
        drawBackground(): void;
        wasMounted(): void;
        wasUnmounted(): void;
        ...
        private attachMountHandlers;
        protected childByKey(key: string): HTMLElement | Component;
    }
    abstract class PureComponent<I = {}> extends Component<I> {
        setInput(input: I): void;
    }
    class Renderer {
        private components;
        private previousComponents;
        private elements;
        private previousElements;
        ...
        setupForNewRenderPass(): void;
        getElementByKey(key: string): HTMLElement | Component | null;
    }
    function updateChildren(parent: HTMLElement, children: (HTMLElement | Nitro.Component)[]): void;
}
